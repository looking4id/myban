...
/* Added FileText to imports, removed non-existent CornerDownRight and ListPlus */
import { Plus, ZoomIn, ZoomOut, Grid, XCircle, Trash2, Edit3, ChevronRight, FileText } from '../Icons';
...
export const TestCaseMindmap = ({ 
  ...
  /* Wrapped TreeNode with React.FC to allow 'key' prop and resolve TypeScript assignment error */
                ...
                {!isRoot && (
                  <>
                    <button 
                      ...
                      title="添加同级 (Enter)"
                    >
                      {/* Switched ListPlus to Plus as ListPlus is not exported */}
                      <Plus size={14} />
                    </button>
                    <button 
