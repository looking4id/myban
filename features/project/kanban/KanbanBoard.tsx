...
// ... EditorToolbar and CreateTaskModal are large, keeping logic identical but imported from new paths
const EditorToolbar = () => (
                        ...
                        <div className="flex-1 flex p-8 gap-8 overflow-y-auto custom-scrollbar bg-white">
                            <div className="flex-1 space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <input className="w-full border border-slate-300 rounded px-3 py-2 text-sm focus:border-blue-500 outline-none placeholder:text-slate-300 transition-all" placeholder="请填写" value={title} onChange={e => setTitle(e.target.value)} />
                                </div>
                            ...
                            <div className="w-72 border-l border-slate-100 pl-8 space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <select className="w-full border border-slate-300 rounded px-3 py-2 text-sm appearance-none outline-none focus:border-blue-500 text-slate-500 bg-white"><option>选择标签</option></select>
                                        <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
                                    </div>
                                </div>
                                <div className="space-y-2">
