...
export const MOCK_COLUMNS: Column[] = [
  {
    id: 'todo', title: '待办的', count: 5, iconColor: 'text-gray-400',
    tasks: [
  ...
  {
    id: 'inprogress', title: '进行中', count: 4, iconColor: 'text-blue-500',
    tasks: [
  ...
  {
    id: 'done', title: '已完成', count: 3, iconColor: 'text-green-500',
    tasks: [
